...
export const CONTENTS = [
  ...
  },
  {
    title: '건축물',
    desc:
      '도깨비공원에는 21개의 건축물이 있습니다. 각각의 건축물은 한 사람을 위한 공간부터 많은 사람들이 영상을 보고 여러 가지 체험을 할 수 있는 공간까지 크기와 모양, 쓰임이 다양합니다. 도깨비 가면을 만들 수 있는 가면체험관, 도깨비 입속으로 들어가는 경험을 할 수 있는 깨뽀 영상관, 세상에서 가장 큰 부적인 돌아봐세바퀴, 눈을 깜빡이며 노래하는 깨슈타인타워 등 모든 건축물은 각각의 이야기와 역사를 갖습니다. 건축물 컬렉션에서는 건축물의 예전 사진과 현재의 모습 그리고 어떠한 목적으로 각 건물이 탄생했는지 살펴볼 수 있습니다.\n' +
      '\n' +
